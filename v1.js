...
function set_FC_to_v1(serialport) {
  ...
  let buf_set_to_v1 = Buffer.from([
    253, 23, 0, 0, 0, 1, 255, 23, 0, 0, 1, 0, 0, 0, 1, 1, 77, 65, 86, 95, 80,
    82, 79, 84, 79, 95, 86, 69, 82, 0, 204, 255, 6, 111, 118,
  ]);
...
function set_FC_to_v2(serialport) {
  //Hardcoded karena keterbatasan library
  let buf_set_to_v2 = Buffer.from([
    253, 23, 0, 0, 0, 1, 255, 23, 0, 0, 2, 0, 0, 0, 1, 1, 77, 65, 86, 95, 80,
    82, 79, 84, 79, 95, 86, 69, 82, 0, 204, 255, 6, 163, 155,
  ]);
...
function readAllParameters(serialport, v1, FC_v2_compatibility, use_v1) {
  ...
  setTimeout(() => {
    v1.mavLinkv1send.createMessage(
      "PARAM_REQUEST_LIST",
      {
        target_system: 1,
